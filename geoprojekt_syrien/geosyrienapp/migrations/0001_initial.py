    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('refTotal', models.IntegerField(null=True)),
                ('male', models.IntegerField(null=True)),
                ('female', models.IntegerField(null=True)),
                ('u18', models.IntegerField(null=True)),
                ('u18erstantrag', models.IntegerField(null=True)),
                ('u34', models.IntegerField(null=True)),
                ('u34erstantrag', models.IntegerField(null=True)),
                ('u64', models.IntegerField(null=True)),
                ('u64erstantrag', models.IntegerField(null=True)),
                ('ue65', models.IntegerField(null=True)),
                ('ue65erstantrag', models.IntegerField(null=True)),
                ('unknown', models.IntegerField(null=True)),
                ('erstantrag', models.IntegerField(null=True)),
                ('folgeantrag', models.IntegerField(null=True)),
            ],
            options={
